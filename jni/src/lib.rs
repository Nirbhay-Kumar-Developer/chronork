...
use chronork_core::models::DailyLog;
...
#[no_mangle]
pub extern "system" fn Java_com_chronork_app_NativeCore_getLog<'local>(
...
#[no_mangle]
pub extern "system" fn Java_com_chronork_app_NativeCore_storeLog<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    app_files_dir: JString<'local>,
